...
需要注意的是，在广义概念中添加了“共识”的理念。实际上，对于现阶段区块链发展，就是因为有了共识机制才能被世界广泛关注。

去中心化和共识是两个概念，两者结合这才是真正意义上的“去中心化”，去中心化有了共识才具备了完全的可信度，否则只是狭义概念的数据共享，没人知道这些共享的数据是否真实，或者被集体认可，仅仅只是拥有这些信息；共识有了去中心化，就具备了安全性，很难被攻击，被篡改；再加上特殊的数据结构，而这一切的实现就是区块链。
